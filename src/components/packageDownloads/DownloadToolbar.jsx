/**
 * DownloadToolbar Component
 * Top toolbar for package downloads
 * 
 * Location: src/components/packageDownloads/DownloadToolbar.jsx
 */
  ...
  return (
    ...
    >
      ...
      <Box display="flex" gap={1} flexWrap="wrap">
        ...
        <Tooltip title="Export download report">
          <Button
            variant="outlined"
